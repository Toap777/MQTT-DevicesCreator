...
public abstract class GenericClient extends BasicClientMQTT{
    ...
    /**
     * Connects to a mqtt broker using tcp and IP address setting the specified username and password as connection defaults. Registers a callback for incoming messages
